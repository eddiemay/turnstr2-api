...
ActiveRecord::Schema.define(version: 20170614073124) do
  ...
  create_table "stories", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "story_face1_updated_at"
    t.string   "story_face2_file_name"
    t.string   "story_face2_content_type"
    t.integer  "story_face2_file_size"
    t.datetime "story_face2_updated_at"
    t.string   "story_face3_file_name"
    t.string   "story_face3_content_type"
    t.integer  "story_face3_file_size"
    t.datetime "story_face3_updated_at"
    t.string   "story_face4_file_name"
